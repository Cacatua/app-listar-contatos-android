package com.kktua.contatosbootcamp
    ...
    private fun setContacts() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                contactList.add(Contact(cursor.getString(displayName), cursor.getString(number)))
            }
            cursor.close()
        }
        ...
        contactRecyclerView.layoutManager = LinearLayoutManager(this, RecyclerView.VERTICAL, false)
